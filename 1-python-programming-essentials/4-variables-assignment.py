...
assignment - how you assign a value to a variable
use = equal sign to assign
print(A,B) comma is a space
print("", expression, function, calculation) - can print characters with "", expression/cacluation, and use function
choose a meaningful name - 3 letters or above
"""
